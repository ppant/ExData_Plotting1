## R script for producing plot 4 -- Explorartory data analysis
...
globalReactivePower <- as.numeric(subSetDataOndates$Global_reactive_power)
Voltage <- as.numeric(subSetDataOndates$Voltage)
...
## Create final plots with lines type="l"
par(mfrow = c(2, 2)) 
## 4 plots will created in 2x2 row 
plot(dateandtime, globalActivePower, type = "l", ylab="Global Active Power",xlab = "datetime")
plot(dateandtime, Voltage, type = "l", ylab="Voltage", xlab = "datetime")
plot(dateandtime, subMeteringData1, type = "l", ylab="Energy sub metering",xlab = "datetime")
lines(dateandtime, subMeteringData2, type="l", col="red")
lines(dateandtime, subMeteringData3, type="l", col="blue")
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, lwd=2.5, col=c("black", "red", "blue"))
plot(dateandtime, globalReactivePower, type = "l", ylab="Global_reactive_meter",xlab = "datetime")
dev.off()