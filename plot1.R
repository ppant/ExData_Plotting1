...
consumDataNew <- read.table("./projectData/household_power_consumption.txt", header =TRUE, sep = ";", stringsAsFactors=FALSE, dec=".")

## We need to sub set data frame based on two dates 2007-02-01 and 2007-02-02 (for 1 day)
## ##Test --- To do that we need to create date/time objects
...
# Start plooting as per assignment
